...
In contrast to BSV, Bitcoin Cash has worked continually to improve the functionality of the virtual machine. Bitcoin Cash has also worked to increase the block size while taking care to optimize the rest of the ecosystem for increased throughput. This more thought-out approach has led to very stable network upgrades.
